...
import com.example.hangamanga.databinding.FragmentPickToPlayCategoryBinding
...
class PickToPlayCategoryFragment : Fragment() {
    private lateinit var _binding: FragmentPickToPlayCategoryBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPickToPlayCategoryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecyclerView(words: List<Word>) {
        categoryAdapter = CategoryRecyclerViewAdapter(getCategories(words), true)
        binding.list.apply {
